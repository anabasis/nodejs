...
<tr><td>Tables with custom renderers</td><td>검색 결과에 스파크 라인을 포함하는 테이블, 사용자 정의 셀 렌더러 및 사용자 정의 행 렌더러를 표시하는 방법을 보여줍니다.</td><td>04.Tables Example</td><td>example_customtables</td></tr>
<tr><td>Events viewers</td><td>가능한 이벤트 뷰어 유형에 대한 예제를 보여줍니다.</td><td>05.Events viewers</td><td>example_eventsviewers</td></tr>
<tr><td>Maps</td><td>Splunk 맵에 표시되는 데이터를 표시합니다.</td><td>06.Map Example</td><td>example_map</td></tr>
<tr><td>Drilldown properties</td><td>드릴 다운 작업을 허용하는보기에 대해 다양한 드릴 다운 등록 정보 조합을 설정 한 결과를 표시합니다.</td><td>07.Drilldown properties</td><td>example_drilldown</td></tr>
<tr><td>Search controls using tokens</td><td>토큰을 사용하여 검색 컨트롤을 검색 관리자와 동기화하는 방법을 보여줍니다.</td><td>08.Search controls using tokens</td><td>example_searchcontrolstokens</td></tr>
<tr><td>Search controls using events</td><td>변경 이벤트를 사용하여 검색 컨트롤을 검색 관리자와 동기화하는 방법을 보여줍니다.</td><td>09.Search controls using events</td><td>example_searchcontrolsevents</td></tr>
<tr><td>Search progress events</td><td>검색 상태 및 검색 작업의 속성을 비롯하여 검색 진행률을 검색하는 방법을 보여줍니다.</td><td>10.Search progress events</td><td>example_progressevents</td></tr>
<tr><td>Search results model</td><td>이벤트, 미리보기, 결과 및 요약과 같은 결과 유형에서 검색 결과의 다양한 유형을 검색하는 방법을 보여줍니다.</td><td>11.Search results model</td><td>example_resultsmodel</td></tr>
<tr><td>Token manipulation</td><td>드롭 다운 목록에서 선택된 색인 값을 사용하여 검색을 실행하는 토큰 사용 방법을 보여줍니다. 토큰은 토큰 변경 이벤트 핸들러를 사용하여 조작됩니다.</td><td>12.Token manipulation</td><td>example_tokensmanip</td></tr>
<tr><td>Token transform and forwarding</td><td>토큰 필터 및 전달자를 사용하여 토큰 값을 변경하는 여러 가지 방법을 보여줍니다.</td><td>13.Token transform and forwarding</td><td>example_tokenstransform</td></tr>
</table>
...
- <http://localhost:port/app/mysplunkapp/example_basicpage>
...
- <http://localhost:port/app/mysplunkapp/example_all>
