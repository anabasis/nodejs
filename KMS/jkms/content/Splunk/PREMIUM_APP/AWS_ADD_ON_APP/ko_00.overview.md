...
Splunkbase에서 [Amazon Web Services 용 Splunk Add-on](http://splunkbase.splunk.com/app/1876)을 다운로드하십시오.
...
- 비용 및 사용 보고서 데이터를 수집하기위한 청구 입력 구성 지원 (Sourcetype :`aws:billing:cur`).
