...
Configure a Config input using Splunk Web (recommended)
...
If you modify the default value of aws:config, you will see <yourcustomsourcetype>:notification and <yourcustomsourcetype>:log.
...
Set up a dead-letter queue and the SQS visibility timeout setting for the SQS queue from which you are collecting Config data. See Configure SQS.
